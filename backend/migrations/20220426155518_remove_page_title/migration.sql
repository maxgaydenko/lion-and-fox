...
INSERT INTO "new_Page" ("content", "hasBlazon", "id", "isPublished", "menuName", "menuSection", "pos", "url") SELECT "content", "hasBlazon", "id", "isPublished", "menuName", "menuSection", "pos", "url" FROM "Page";
DROP TABLE "Page";
